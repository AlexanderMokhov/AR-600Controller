...
void MainWindow::WidgetsInit()
{
    ...
    mConnectDialog = new ConnectionSetupDialog();
    ...
    mAdditionCW = new AdditionalControlW();
    ui->AdditionalLayout->addWidget(mAdditionCW);
